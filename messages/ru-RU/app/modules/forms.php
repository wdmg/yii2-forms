...
return [
    ...
    'Filling results' => 'Результаты заполнения',

    'Update form' => 'Редактирование формы',
    'Update form: {name}' => 'Редактирование формы: {name}',


    'Create field' => 'Создание поля',
    'Create new field' => 'Добавить поле',
    ...
    'Are you sure you want to delete the language version of this form?' => "Вы действительно желаете удалить языковую версию формы?",
    'Are you sure you want to delete the language version of this field?' => "Вы действительно желаете удалить языковую версию поля?",

    'The requested form does not exist.' => "Запрошенная форма не найдена.",
